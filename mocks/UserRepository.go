...
func (_m *MockUserRepository) FindByID(ctx context.Context, id primitive.ObjectID) (*model.User, error) {
...
func (_c *MockUserRepository_FindByID_Call) RunAndReturn(run func(context.Context, primitive.ObjectID) (*model.User, error)) *MockUserRepository_FindByID_Call {
	_c.Call.Return(run)
	return _c
}
